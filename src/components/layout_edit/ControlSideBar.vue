<template>
  <aside class="control-sidebar control-sidebar-dark" style="display: block">
      <div class="p-3 control-sidebar-content" style="">
        ...
        <div class="mb-1">
          <input type="checkbox" @click="handleSideBar()" value="1" class="mr-1" /><span>Collapsed</span>
        </div>
        <div class="mb-1">
...
// layout-navbar-fixed"
const isNavbarFix = ref(false);
function handlenavbarfixed() {
  if (isNavbarFix.value == false) {
    $("body").addClass("layout-navbar-fixed");
    isNavbarFix.value = true;
  } else {
    $("body").removeClass("layout-navbar-fixed");
    isNavbarFix.value = false;
  }
}
