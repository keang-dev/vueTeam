<template>
  <div class="wrapper">
    <NavBar v-if="isNav"/>
    <nav class="main-header navbar navbar-expand navbar-white navbar-light fade show" v-show="!isNav">
      <ul class="navbar-nav">
        <li class="nav-item">
